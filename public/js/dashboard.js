...
TinyShop.initProductList = function() {
  ...
  $("#bulkArchiveBtn").on("click", function() {
    ...
    TinyShop.confirm("Hide " + label + "?", "They won't show in your shop until you unhide them.", "Hide", function() {
      TinyShop.closeModal();
      TinyShop.api("POST", "/api/products/bulk-archive", { ids }).done(function(res) {
  ...
  $("#bulkDeleteBtn").on("click", function() {
    ...
    TinyShop.confirm("Delete " + label + "?", "This will permanently delete the selected products and their images. This cannot be undone.", "Delete", function() {
      TinyShop.closeModal();
      TinyShop.api("POST", "/api/products/bulk-delete", { ids }).done(function(res) {
  ...
  $grid.on("click", ".product-share-btn", function(e) {
    ...
    $(".share-quick-btns-modal .share-quick-btn").on("click", function() {
      ...
      switch (channel) {
        case "whatsapp":
          link = "https://wa.me/?text=" + text + "%20" + tracked;
          break;
        case "facebook":
          link = "https://www.facebook.com/sharer/sharer.php?u=" + tracked;
          break;
        case "x":
          link = "https://twitter.com/intent/tweet?text=" + text + "&url=" + tracked;
          break;
        case "email":
          link = "mailto:?subject=" + text + "&body=" + tracked;
          break;
      }
