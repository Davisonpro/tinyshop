...
-- Remove previously seeded articles (preserves any admin-created ones)
DELETE FROM `help_articles` WHERE `slug` IN (
    'creating-your-account', 'quick-start-guide', 'understanding-your-dashboard',
    'adding-a-new-product', 'editing-and-deleting-products', 'writing-great-product-descriptions',
    'creating-and-managing-categories',
    'viewing-and-managing-orders', 'order-notifications', 'handling-refunds-and-cancellations',
    'setting-up-payment-methods', 'understanding-transaction-fees',
    'choosing-a-shop-theme', 'customizing-your-shop-appearance',
    'configuring-shop-details', 'enabling-cash-on-delivery',
    'sharing-your-shop-link', 'connecting-a-custom-domain',
    'creating-a-coupon-code', 'coupon-best-practices',
    'understanding-your-analytics',
    'choosing-the-right-plan', 'managing-your-subscription',
    'changing-your-password', 'updating-your-email-address', 'deleting-your-account',
    'how-checkout-works', 'order-tracking-for-customers', 'supported-payment-methods-for-buyers'
);

-- Seed 29 help articles for testing
-- NOTE: Use HTML entities for special chars (&rarr; &mdash; &ndash; &times;) to avoid encoding issues
