/**
 * TinyShop Starter Theme
 *
 * Entry point for all theme-specific UI behaviour.
 * Modules: HeroSlider, ScrollArrows, ScrollReveal, ImageReveal
 *
 * Conventions
...
(function () {
    ...
    /* ================================================================
       SCROLL REVEAL — Framer-like entrance animations
       Adds .reveal to sections, .revealed when they enter viewport.
       Stagger children with .d1 .d2 .d3 .d4 classes.
       ================================================================ */
