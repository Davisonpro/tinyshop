    ...
    <div class="product-card-img">
        ...
        {if !$product.is_sold}
            {if !empty($product.variations_data)}
                <button type="button" class="product-card-atc product-card-atc-options">Choose Options</button>
            {else}
                <button type="button" class="product-card-atc"
                    ...
                    data-product-slug="{$product.slug|default:$product.id}">Add to Cart</button>
            {/if}
        {/if}
    </div>
