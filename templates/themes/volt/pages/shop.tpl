...
<div class="shop-page" data-subdomain="{$shop.subdomain|escape}" data-total="{$total_products}" data-limit="{$products_limit}" data-currency="{$currency_symbol|escape}">
    <div class="container">
        ...
        <div class="search-empty" id="searchEmpty" style="display:none">
            ...
            <p class="search-empty-hint">Try a different query</p>
        </div>

        <section class="product-grid volt-grid" id="catalogue">
            ...
            {foreachelse}
                <div class="empty-state">
                    ...
                    <p><strong>No products loaded</strong></p>
                    <p style="font-size:0.8125rem">Nothing here yet — check back later.</p>
                </div>
            {/foreach}
        </section>
...
{* Volt theme renderer — overlay card with gradient, monospace prices *}
<script>
