...
{if !$product.is_sold}
    ...
    {elseif $shop.contact_whatsapp}
        <div class="sticky-cta">
            <a href="https://wa.me/{$shop.contact_whatsapp}?text={("Hi! I'd love to know more about: "|cat:$product.name)|escape:'url'}" class="btn btn-whatsapp" target="_blank" rel="noopener">
    ...
    {elseif $shop.contact_email}
        <div class="sticky-cta">
            <a href="mailto:{$shop.contact_email}?subject={("Inquiry about: "|cat:$product.name)|escape:'url'}" class="btn btn-accent">
