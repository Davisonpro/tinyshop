{* Monaco product CTA — gold, uppercase, text-only *}
{if !$product.is_sold}
    ...
    {elseif $shop.contact_whatsapp}
        <div class="sticky-cta">
            <a href="https://wa.me/{$shop.contact_whatsapp}?text={("I'd like to enquire about: "|cat:$product.name)|escape:'url'}" class="btn btn-whatsapp" target="_blank" rel="noopener">
    ...
    {elseif $shop.contact_email}
        <div class="sticky-cta">
            <a href="mailto:{$shop.contact_email}?subject={("Enquiry: "|cat:$product.name)|escape:'url'}" class="btn btn-accent">
