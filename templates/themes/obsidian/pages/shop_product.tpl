...
<div class="product-page">
    <div class="container">
        {* Full-bleed Image Gallery — square aspect ratio *}
        ...
        {* Product Info — brutalist hierarchy *}
        <div class="product-info">
            {if $product.category_name}
                <span class="product-info-category">{$product.category_name|escape}</span>
            {/if}
            <div class="obsidian-drop-label">DROP</div>
            <h1 class="product-info-name">{$product.name|escape}</h1>

            <div class="product-info-price obsidian-price-block" id="productPriceArea">
    ...
    <div class="container">
        <div class="more-products">
            <h2 class="more-products-title">More Drops</h2>
