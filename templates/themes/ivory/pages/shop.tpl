...
<div class="shop-page" data-subdomain="{$shop.subdomain|escape}" data-total="{$total_products}" data-limit="{$products_limit}" data-currency="{$currency_symbol|escape}">
    <div class="container">
        ...
        <div class="shop-search" id="shopSearch">
            ...
            <input type="text" class="shop-search-input" id="searchInput" placeholder="Search..." autocomplete="off">
        ...
        <div class="ivory-collection-label">Collection</div>

        <section class="product-grid ivory-grid" id="catalogue">
            ...
            {foreachelse}
                <div class="empty-state">
                    ...
                    <p style="font-size:0.8125rem; color:var(--color-text-muted)">The shop is getting set up.</p>
                </div>
            {/foreach}
        </section>
