...
<input type="hidden" id="platformStripeEnabled" value="{$settings.platform_stripe_enabled|default:'0'}">
...
<input type="hidden" id="platformPaypalEnabled" value="{$settings.platform_paypal_enabled|default:'0'}">
...
<input type="hidden" id="platformMpesaEnabled" value="{$settings.platform_mpesa_enabled|default:'0'}">
<input type="hidden" id="platformPesapalConsumerKey" value="{$settings.platform_pesapal_consumer_key|escape}">
<input type="hidden" id="platformPesapalConsumerSecret" value="{$settings.platform_pesapal_consumer_secret|escape}">
<input type="hidden" id="platformPesapalMode" value="{$settings.platform_pesapal_mode|default:'test'}">
<input type="hidden" id="platformPesapalEnabled" value="{$settings.platform_pesapal_enabled|default:'0'}">
        ...
        <div class="account-row" id="setupPlatformStripeBtn">
            <div class="account-row-left">
                ...
                <div>
                    ...
                    <div class="account-row-value" id="platformStripeStatusDisplay">{if $settings.platform_stripe_secret_key}{if $settings.platform_stripe_enabled}Enabled{else}Disabled{/if}{else}Not connected{/if}</div>
                </div>
            </div>
            {if $settings.platform_stripe_secret_key}
            <span class="gateway-status-badge{if !$settings.platform_stripe_enabled} badge-disabled{/if}">
                {if $settings.platform_stripe_enabled}<i class="fa-solid fa-check icon-xs"></i>{/if}
                {if $settings.platform_stripe_enabled}{if $settings.platform_stripe_mode == 'live'}Live{else}Test{/if}{else}Off{/if}
            </span>
            {else}
        ...
        <div class="account-row" id="setupPlatformPaypalBtn">
            <div class="account-row-left">
                ...
                <div>
                    ...
                    <div class="account-row-value" id="platformPaypalStatusDisplay">{if $settings.platform_paypal_client_id}{if $settings.platform_paypal_enabled}Enabled{else}Disabled{/if}{else}Not connected{/if}</div>
                </div>
            </div>
            {if $settings.platform_paypal_client_id}
            <span class="gateway-status-badge{if !$settings.platform_paypal_enabled} badge-disabled{/if}">
                {if $settings.platform_paypal_enabled}<i class="fa-solid fa-check icon-xs"></i>{/if}
                {if $settings.platform_paypal_enabled}{if $settings.platform_paypal_mode == 'live'}Live{else}Test{/if}{else}Off{/if}
            </span>
            {else}
            <i class="fa-solid fa-chevron-right account-row-chevron"></i>
            {/if}
        ...
        <div class="account-row" id="setupPlatformMpesaBtn">
            <div class="account-row-left">
                ...
                <div>
                    ...
                    <div class="account-row-value" id="platformMpesaStatusDisplay">{if $settings.platform_mpesa_shortcode}{if $settings.platform_mpesa_enabled}Enabled{else}Disabled{/if}{else}Not connected{/if}</div>
                </div>
            </div>
            {if $settings.platform_mpesa_shortcode}
            <span class="gateway-status-badge{if !$settings.platform_mpesa_enabled} badge-disabled{/if}">
                {if $settings.platform_mpesa_enabled}<i class="fa-solid fa-check icon-xs"></i>{/if}
                {if $settings.platform_mpesa_enabled}{if $settings.platform_mpesa_mode == 'live'}Live{else}Test{/if}{else}Off{/if}
            </span>
            {else}
            <i class="fa-solid fa-chevron-right account-row-chevron"></i>
            {/if}
        </div>
        <div class="account-row" id="setupPlatformPesapalBtn">
            <div class="account-row-left">
                ...
                <div>
                    ...
                    <div class="account-row-value" id="platformPesapalStatusDisplay">{if $settings.platform_pesapal_consumer_key}{if $settings.platform_pesapal_enabled}Enabled{else}Disabled{/if}{else}Not connected{/if}</div>
                </div>
            </div>
            {if $settings.platform_pesapal_consumer_key}
            <span class="gateway-status-badge{if !$settings.platform_pesapal_enabled} badge-disabled{/if}">
                {if $settings.platform_pesapal_enabled}<i class="fa-solid fa-check icon-xs"></i>{/if}
                {if $settings.platform_pesapal_enabled}{if $settings.platform_pesapal_mode == 'live'}Live{else}Test{/if}{else}Off{/if}
            </span>
            {else}
            <i class="fa-solid fa-chevron-right account-row-chevron"></i>
            {/if}
...
(function() {ldelim}
    ...
    $('#setupPlatformStripeBtn').on('click', function() {ldelim}
        ...
        var currentEnabled = $('#platformStripeEnabled').val() === '1';
        ...
        var html = '<form id="platformStripeForm" autocomplete="off">' +
            ...
            '<div class="form-toggle-row mb-md">' +
                '<div>' +
                    '<div class="form-toggle-label">Enabled</div>' +
                    '<p class="form-hint mt-xs">Allow sellers to pay with Stripe</p>' +
                '</div>' +
                '<label class="toggle-switch">' +
                    '<input type="checkbox" id="modalPlatformStripeEnabled"' + (currentEnabled ? ' checked' : '') + '>' +
                    '<span class="toggle-slider"></span>' +
                '</label>' +
            '</div>' +
        ...
        $('#platformStripeForm').on('submit', function(e) {ldelim}
            ...
            var enabled = $('#modalPlatformStripeEnabled').is(':checked') ? '1' : '0';
            if (!pk || !sk) {ldelim}
    ...
    $('#setupPlatformPaypalBtn').on('click', function() {ldelim}
        ...
        var currentEnabled = $('#platformPaypalEnabled').val() === '1';
        ...
        var html = '<form id="platformPaypalForm" autocomplete="off">' +
            ...
            '<div class="form-toggle-row mb-md">' +
                '<div>' +
                    '<div class="form-toggle-label">Enabled</div>' +
                    '<p class="form-hint mt-xs">Allow sellers to pay with PayPal</p>' +
                '</div>' +
                '<label class="toggle-switch">' +
                    '<input type="checkbox" id="modalPlatformPaypalEnabled"' + (currentEnabled ? ' checked' : '') + '>' +
                    '<span class="toggle-slider"></span>' +
                '</label>' +
            '</div>' +
        ...
        $('#platformPaypalForm').on('submit', function(e) {ldelim}
            ...
            var enabled = $('#modalPlatformPaypalEnabled').is(':checked') ? '1' : '0';
            ...
            TinyShop.api('PUT', '/api/admin/settings', {ldelim}
                ...
                platform_paypal_enabled: enabled
            {rdelim}).done(function() {ldelim}
                $('#platformPaypalClientId').val(cid);
                $('#platformPaypalSecret').val(secret);
                $('#platformPaypalMode').val(mode);
                $('#platformPaypalEnabled').val(enabled);
                TinyShop.toast('PayPal settings saved!');
                TinyShop.closeModal();
                setTimeout(function() {ldelim} location.reload(); {rdelim}, 400);
            {rdelim}).fail(function(xhr) {ldelim}
                var msg = xhr.responseJSON ? xhr.responseJSON.message : 'Failed to save';
    ...
    $('#setupPlatformMpesaBtn').on('click', function() {ldelim}
        ...
        var currentEnabled = $('#platformMpesaEnabled').val() === '1';
        ...
        var html = '<form id="platformMpesaForm" autocomplete="off">' +
            ...
            '<div class="form-toggle-row mb-md">' +
                '<div>' +
                    '<div class="form-toggle-label">Enabled</div>' +
                    '<p class="form-hint mt-xs">Allow sellers to pay with M-Pesa</p>' +
                '</div>' +
                '<label class="toggle-switch">' +
                    '<input type="checkbox" id="modalPlatformMpesaEnabled"' + (currentEnabled ? ' checked' : '') + '>' +
                    '<span class="toggle-slider"></span>' +
                '</label>' +
            '</div>' +
        ...
        $('#platformMpesaForm').on('submit', function(e) {ldelim}
            ...
            var enabled = $('#modalPlatformMpesaEnabled').is(':checked') ? '1' : '0';
            ...
            TinyShop.api('PUT', '/api/admin/settings', {ldelim}
                ...
                platform_mpesa_enabled: enabled
            {rdelim}).done(function() {ldelim}
                ...
                $('#platformMpesaEnabled').val(enabled);
                TinyShop.toast('M-Pesa settings saved!');
                TinyShop.closeModal();
                setTimeout(function() {ldelim} location.reload(); {rdelim}, 400);
            {rdelim}).fail(function(xhr) {ldelim}
                var msg = xhr.responseJSON ? xhr.responseJSON.message : 'Failed to save';
    ...
    // --- Platform Pesapal setup (modal) ---
    $('#setupPlatformPesapalBtn').on('click', function() {ldelim}
        var currentKey = $('#platformPesapalConsumerKey').val();
        var currentSecret = $('#platformPesapalConsumerSecret').val();
        var currentMode = $('#platformPesapalMode').val();
        var currentEnabled = $('#platformPesapalEnabled').val() === '1';
        var isConnected = currentKey !== '';

        var html = '<form id="platformPesapalForm" autocomplete="off">' +
            '<div class="gateway-modal-header">' +
                ...
                '<span class="gateway-brand-name">Pesapal</span>' +
                (isConnected ? '<span class="gateway-status-badge"><i class="fa-solid fa-check icon-xs"></i> Connected</span>' : '') +
            '</div>' +
            '<div class="form-group">' +
                '<label for="modalPlatformPesapalKey">Consumer Key</label>' +
                '<input type="text" class="form-control" id="modalPlatformPesapalKey" value="' + escapeHtml(currentKey) + '" placeholder="From Pesapal merchant portal" autocomplete="off">' +
            '</div>' +
            '<div class="form-group">' +
                '<label for="modalPlatformPesapalSecret">Consumer Secret</label>' +
                '<div class="password-field"><input type="password" class="form-control" id="modalPlatformPesapalSecret" value="' + escapeHtml(currentSecret) + '" placeholder="From Pesapal merchant portal" autocomplete="off">' +
                '<button type="button" class="password-toggle" onclick="togglePw(this)" aria-label="Show password"><i class="fa-solid fa-eye eye-open"></i><i class="fa-solid fa-eye-slash eye-closed d-none"></i></button></div>' +
            '</div>' +
            '<div class="form-toggle-row mb-md">' +
                '<div>' +
                ...
                '</div>' +
                '<label class="toggle-switch">' +
                    '<input type="checkbox" id="modalPlatformPesapalMode"' + (currentMode === 'live' ? ' checked' : '') + '>' +
                    '<span class="toggle-slider"></span>' +
                '</label>' +
            '</div>' +
            '<div class="form-toggle-row mb-md">' +
                '<div>' +
                    '<div class="form-toggle-label">Enabled</div>' +
                    '<p class="form-hint mt-xs">Allow sellers to pay with Pesapal</p>' +
                '</div>' +
                '<label class="toggle-switch">' +
                    '<input type="checkbox" id="modalPlatformPesapalEnabled"' + (currentEnabled ? ' checked' : '') + '>' +
                    '<span class="toggle-slider"></span>' +
                '</label>' +
            '</div>' +
            '<button type="submit" class="btn-block btn-primary" id="savePlatformPesapalBtn">Save Pesapal Settings</button>' +
            (isConnected ? '<button type="button" class="btn-block btn-link mt-sm" id="disconnectPlatformPesapalBtn">Disconnect Pesapal</button>' : '') +
        '</form>';
        TinyShop.openModal('Platform Pesapal', html);

        $('#platformPesapalForm').on('submit', function(e) {ldelim}
            e.preventDefault();
            var key = $('#modalPlatformPesapalKey').val().trim();
            var secret = $('#modalPlatformPesapalSecret').val().trim();
            var mode = $('#modalPlatformPesapalMode').is(':checked') ? 'live' : 'test';
            var enabled = $('#modalPlatformPesapalEnabled').is(':checked') ? '1' : '0';
            if (!key || !secret) {ldelim}
                TinyShop.toast('All fields are required', 'error');
                return;
            {rdelim}
            var $btn = $('#savePlatformPesapalBtn').prop('disabled', true).text('Saving...');
            TinyShop.api('PUT', '/api/admin/settings', {ldelim}
                platform_pesapal_consumer_key: key,
                platform_pesapal_consumer_secret: secret,
                platform_pesapal_mode: mode,
                platform_pesapal_enabled: enabled
            {rdelim}).done(function() {ldelim}
                $('#platformPesapalConsumerKey').val(key);
                $('#platformPesapalConsumerSecret').val(secret);
                $('#platformPesapalMode').val(mode);
                $('#platformPesapalEnabled').val(enabled);
                TinyShop.toast('Pesapal settings saved!');
                TinyShop.closeModal();
                setTimeout(function() {ldelim} location.reload(); {rdelim}, 400);
            {rdelim}).fail(function(xhr) {ldelim}
                var msg = xhr.responseJSON ? xhr.responseJSON.message : 'Failed to save';
        ...
        $('#disconnectPlatformPesapalBtn').on('click', function() {ldelim}
            TinyShop.confirm('Disconnect Pesapal?', 'Sellers won\'t be able to pay for subscriptions with Pesapal.', 'Disconnect', function() {ldelim}
                $('#confirmModalOk').prop('disabled', true).text('Disconnecting...');
                TinyShop.api('PUT', '/api/admin/settings', {ldelim}
                    platform_pesapal_consumer_key: '',
                    platform_pesapal_consumer_secret: '',
                    platform_pesapal_mode: 'test',
                    platform_pesapal_enabled: '0'
                {rdelim}).done(function() {ldelim}
                    $('#platformPesapalConsumerKey').val('');
                    $('#platformPesapalConsumerSecret').val('');
                    $('#platformPesapalMode').val('test');
                    $('#platformPesapalEnabled').val('0');
