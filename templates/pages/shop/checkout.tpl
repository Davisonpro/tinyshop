        ...
        <div id="checkoutForm" style="display:none">
            ...
            <div class="checkout-section">
                ...
                <div class="gateway-picker">
                    {if $has_stripe}
                    <div class="gateway-option" data-gateway="stripe">
                        <div class="gateway-option-icon">
                            <i class="fa-brands fa-stripe" style="color:#635BFF"></i>
                        </div>
                        <div class="gateway-option-info">
                            <div class="gateway-option-name">Credit / Debit Card</div>
                            <div class="gateway-option-desc">Pay securely with your card</div>
                        </div>
                    ...
                    <div class="gateway-option" data-gateway="paypal">
                        ...
                        <div class="gateway-option-info">
                            <div class="gateway-option-name">PayPal</div>
                            <div class="gateway-option-desc">Pay with your PayPal account</div>
                        </div>
                        <div class="gateway-option-check">
                            <i class="fa-solid fa-check"></i>
                        </div>
                    ...
                    {/if}
                    {if $has_cod}
                    <div class="gateway-option" data-gateway="cod">
                        <div class="gateway-option-icon">
                            <i class="fa-solid fa-hand-holding-dollar" style="color:#059669"></i>
                        </div>
                        <div class="gateway-option-info">
                            <div class="gateway-option-name">Pay on Delivery</div>
                            <div class="gateway-option-desc">Cash when you receive your order</div>
                        </div>
                        <div class="gateway-option-check">
                            <i class="fa-solid fa-check"></i>
                        </div>
                    ...
                    {/if}
                    {if $has_mpesa}
                    <div class="gateway-option" data-gateway="mpesa">
                        <div class="gateway-option-icon mpesa">
                        ...
                        <div class="gateway-option-info">
                            <div class="gateway-option-name">M-Pesa</div>
                            <div class="gateway-option-desc">Pay from your M-Pesa account</div>
                        </div>
                        <div class="gateway-option-check">
                            <i class="fa-solid fa-check"></i>
                        </div>
                    ...
                    {/if}
                    {if $has_pesapal}
                    <div class="gateway-option" data-gateway="pesapal">
                        <div class="gateway-option-icon pesapal">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="12" fill="#0A7BC4"/><text x="12" y="16" text-anchor="middle" font-size="9" font-weight="bold" fill="white">PP</text></svg>
                        </div>
                        <div class="gateway-option-info">
                            <div class="gateway-option-name">Pesapal</div>
                            <div class="gateway-option-desc">Cards, mobile money &amp; bank transfer</div>
                        </div>
                        <div class="gateway-option-check">
                            <i class="fa-solid fa-check"></i>
                        </div>
...
(function() {ldelim}
    ...
    // ── Prefill customer details (logged-in account > localStorage) ──
    var loggedCustomer = {ldelim}
        name: '{$checkout_customer.name|escape:"javascript"|default:""}',
        email: '{$checkout_customer.email|escape:"javascript"|default:""}',
        phone: '{$checkout_customer.phone|escape:"javascript"|default:""}'
    {rdelim};

    if (loggedCustomer.name || loggedCustomer.email) {ldelim}
        document.getElementById('coName').value = loggedCustomer.name;
        document.getElementById('coEmail').value = loggedCustomer.email;
        if (loggedCustomer.phone) document.getElementById('coPhone').value = loggedCustomer.phone;
    ...
    $gateways.forEach(function(g) {ldelim}
        g.addEventListener('click', function() {ldelim}
            $gateways.forEach(function(o) {ldelim} o.classList.remove('selected'); {rdelim});
