...
<div class="dash-section">
    ...
    <div class="share-card">
        ...
        <div class="share-link-row">
            ...
            <button type="button" class="btn-share-icon" id="shareShopBtn" title="Share"><i class="fa-solid fa-arrow-up-from-bracket"></i></button>
        </div>
    </div>
</div>
{/if}
...
<div class="dash-section">
    ...
    <div class="quick-actions">
        ...
        <a href="/dashboard/customers" class="action-card">
            <div class="action-icon teal">
        ...
        <a href="/dashboard/import" class="action-card">
...
$(function() {
    ...
    $('#shareShopBtn').on('click', function() {
        var url = encodeURIComponent(shopUrl);
        var text = encodeURIComponent('Check out my shop!');
        ...
        '<div class="share-link-row" style="margin-top:12px">' +
            '<input type="text" value="' + escapeHtml(shopUrl) + '" id="shareModalUrl" readonly>' +
            '<button type="button" class="btn-copy" id="copyShareModalUrl">Copy</button>' +
        '</div>';

        TinyShop.openModal('Share your shop', html);

        $('.share-quick-btns-modal .share-quick-btn').on('click', function() {
            var channel = $(this).data('channel');
            var tracked = encodeURIComponent(shopUrl + '?utm_source=' + channel);
            var link = '';
            switch (channel) {
        ...
        $('#copyShareModalUrl').on('click', function() {
            var $btn = $(this);
            if (navigator.clipboard) {
