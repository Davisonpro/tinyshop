<nav class="dash-tabs" aria-label="Dashboard navigation">
    <a href="/dashboard" class="dash-tab{if $active_page == 'home'} active{/if}"{if $active_page == 'home'} aria-current="page"{/if}>
    ...
    <a href="/dashboard/products" class="dash-tab{if $active_page == 'products'} active{/if}"{if $active_page == 'products'} aria-current="page"{/if}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
        <span>Products</span>
    </a>
    <a href="/dashboard/analytics" class="dash-tab{if $active_page == 'analytics'} active{/if}"{if $active_page == 'analytics'} aria-current="page"{/if}>
    ...
    <a href="/dashboard/shop" class="dash-tab{if $active_page == 'shop'} active{/if}"{if $active_page == 'shop'} aria-current="page"{/if}>
