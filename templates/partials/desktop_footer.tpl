{* Desktop-only footer — hidden on mobile via CSS, shown at 1024px+ *}
{if $shop.show_desktop_footer|default:1}
<footer class="desktop-footer">
    <div class="desktop-footer-inner">
        ...
        <div class="desktop-footer-section">
            <h4 class="desktop-footer-heading">Get in Touch</h4>
        ...
        <div class="desktop-footer-section">
            <h4 class="desktop-footer-heading">Follow Us</h4>
    ...
    <div class="desktop-footer-bottom">
        <span>&copy; {$shop.store_name|escape}</span>
    </div>
</footer>
{/if}
